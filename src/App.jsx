...
const App = () => {
  ...
  const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop", 80001);
  ...
  const { contract: token } = useContract('0x9CD97b01e1E042cE63656E4E6EdC75f2610Ff323', 'token');

  const { contract: vote } = useContract("0xa2699D854Ce73005F181B28bB3770c81b3dc1E7A", "vote");
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>DaoGameToken Member Page</h1>
